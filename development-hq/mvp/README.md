...
`development-hq/MVP.md`의 User Scenario(코드 리뷰 + 테스트 케이스 제안)를 구현한다.

## 실행

```
python3 development-hq/mvp/cli.py <파일 경로>
# 또는
cat some_code.py | python3 development-hq/mvp/cli.py
```

## 테스트

```
python3 -m pytest development-hq/mvp/tests/
```
