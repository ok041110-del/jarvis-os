...
| Field | Value |
|---|---|
| Document ID | RFC-0026 |
| Title | Multi-Agent Workflow — Contract Candidate 조사 및 Boundary (Phase C) |
| Type | RFC |
| Target Domain | Kernel Architecture(Multi-Agent Workflow Contract Candidate, Phase C) |
...
| Parent Documents | `docs/architecture/core/RFC-0024-agent-domain-and-lifecycle-contract.md`(Phase A), `docs/architecture/core/RFC-0025-agent-state-message-event-contract.md`(Phase B) |
| Related Documents | 아래 Related Documents 참고 |
| Evidence References | 아래 §4 Evidence & Validation 참고 |
| Source Path | `docs/architecture/core/RFC-0026-multi-agent-workflow-contract-candidate-boundary.md` |
...
| ADC | `docs/architecture/core/ADC-0032-agent-domain-and-lifecycle-contract-resolution.md` | Phase A 판정(Defer) |
| RFC | `docs/architecture/core/RFC-0025-agent-state-message-event-contract.md` | Phase B 전제 |
| Reference | `hqs/development/IMPLEMENTATION_RULES.md` | §7 근거(Workflow Parser/Scheduler 금지) |
| Reference | `hqs/development/workflow.py` | §3.1 Evidence(코드 조사) |
| Reference | `hqs/investment/teams/stock_team.py` | §3.1 Evidence(코드 조사) |
| Reference | `docs/decisions/adc/ADC.md`(ADC-02) | §0/§4 근거(Runtime 존폐 Open) |
...
| Date | Change | Reason |
|---|---|---|
| — | 최초 작성 | Multi-Agent 운영 대비 Phase C — Multi-Agent Workflow Contract Candidate 조사 |
