...
Accept)가 작성되어 Resolved로 전환됐다 — 후속 `ADR-0011`은 **Proposed
(사용자 승인 대기)**이며, 승인 전까지 `docs/governance/README.md`
추가 반영은 이루어지지 않는다. Kernel 영역도 Development HQ Phase
