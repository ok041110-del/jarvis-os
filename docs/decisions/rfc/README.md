...
| RFC-0010 | `docs/decisions/rfc/` | Outcome-Oriented Governance Model 도입 여부 (사용자 제공 Governance 철학 문서, 기존 "Governance v2" Observation 계층과 명칭 충돌 여부 포함) | Resolved(Decision: Scoped Accept — Q-1/Q-2/Q-3 전부 Accept 또는 Scoped Accept, 소급 미적용) | `docs/governance/adc/ADC-0008.md` | 없음(미작성 — 실제 Baseline 반영 대기) |
...
Scoped Accept, 소급 미적용)가 작성되어 Resolved로 전환됐다 — 단 후속
ADR은 아직 미작성(실제 Baseline 반영 대기). Kernel 영역도 Development HQ Phase
