...
| ADR-0016 | OmniRoute Thin Caller Freeze Scoped Relaxation | ADR | Kernel | Accepted | DG-KERNEL-0023 | `docs/architecture/core/ADC-0027~0031`(5건) | `hqs/development/IMPLEMENTATION_RULES.md`(50행, "Scoped 예외(ADR-0016)" 명시 인용 — 반영 확인됨, 4차 라운드) | 본문 참조 | `docs/architecture/core/ADR-0016-omniroute-thin-caller-freeze-scoped-relaxation.md` | 2026-09-20 | High |
| ADR-0017 | OmniRoute Production Adoption Final Review(Scoped) | ADR | Kernel | Accepted(Production Adoption 선언, Scoped: OmniRoute Thin Engine Caller 형태 한정) | DG-KERNEL-0023 | `docs/architecture/core/ADC-0027~0031`(5건) | `docs/architecture/baseline/BASELINE.md` §"Engine 호출 책임"(386·826·828행, "Implementation Engine으로 Production Adoption됐다(ADR-0017)" 명시 — 반영 확인됨, 4차 라운드) | 본문 참조 | `docs/architecture/core/ADR-0017-omniroute-production-adoption-final-review.md` | 2026-09-20 | High |
| ADR-0018 | LangGraph Adoption Final Review(Consolidation, 10 RFC/10 ADC 종합) | ADR | Kernel | Accepted(LangGraph는 Deferred/Not Adopted로 종결 — 2026-09-08 `ADR-0019`가 이 판정을 부분 Supersede) | DG-KERNEL-0019-GATE | `docs/architecture/core/RFC-0019~0022,0024~0030`(다수) | `docs/architecture/core/ADC-0019~0026,0032,0033`(다수) — Superseded by `docs/architecture/core/ADR-0019` (부분). `docs/architecture/baseline/BASELINE.md`(1365행)에 1회 인용되나 신규 Baseline 절 추가는 없음 — Not Adopted 판정이므로 Baseline에 추가할 내용 자체가 없는 것이 정상(확인됨, 4차 라운드) | 본문 참조 | `docs/architecture/core/ADR-0018-langgraph-adoption-final-review.md` | 2026-09-20 | Medium |
...
| ADR-0020 | Graphify Implementation Technology Adoption | ADR | Kernel | Accepted | DG-KERNEL-0032 | `docs/architecture/core/ADC-0035-graphify-implementation-technology-adoption.md` | `.claude/docs/integrations/graphify.md`(66·72행, "BASELINE.md는 이 Adoption으로 전혀 수정되지 않았다"고 문서 자신이 명시 — 미반영이 아니라 애초에 Baseline 반영 대상이 아님을 확인, 4차 라운드) | 본문 참조 | `docs/architecture/core/ADR-0020-graphify-implementation-technology-adoption.md` | 2026-09-20 | High |
...
| ADR-0024 | Multi-Engine Architecture Adoption(2-Engine: ChatGPT/Claude Code) | ADR | Kernel | Accepted | DG-KERNEL-0036 | `docs/architecture/core/ADC-0039-multi-engine-re-evaluation.md`(Amendment), `docs/architecture/core/ADC-0031-omniroute-thin-engine-caller-boundary.md` | `hqs/development/IMPLEMENTATION_RULES.md` §"Multi-Engine Architecture 허용 범위 (Scoped, ADR-0024)"(54~81행, 반영 확인됨, 4차 라운드) | 본문 참조 | `docs/architecture/core/ADR-0024-multi-engine-architecture-adoption.md` | 2026-09-20 | High |
| ADR-0025 | Stage05 Parallel Validation Architecture Boundary(Scoped) | ADR | Kernel | Accepted(Scoped — Independence/Isolation/Aggregation Boundary만 확정, Production Adoption·Validator LLM Adoption은 NOT YET DETERMINED) | DG-KERNEL-0039 | `docs/architecture/core/ADC-0042-stage05-parallel-validation-dag-decision.md` | `projects/stage05-parallel-validation-harness-v1/README.md`(5·60행, ADR-0025 §14 Non-Goals 인용 — 반영 확인됨, 4차 라운드. `docs/architecture/baseline/BASELINE.md`에는 미반영 — Scoped 상태와 일치, 미결정 부분은 확정하지 않음) | 본문 참조 | `docs/architecture/core/ADR-0025-stage05-parallel-validation-architecture-boundary.md` | 2026-09-20 | High |
| ADR-0026 | OpenRouter Free Model Selection Architecture Boundary(Scoped) | ADR | Kernel | Accepted(Scoped — Architecture Boundary만 확정, Concrete API 구현·Production Routing 실통합은 NOT YET DETERMINED) | DG-KERNEL-0040 | `docs/architecture/core/ADC-0043-openrouter-free-model-selection-decision.md` | `hqs/development/mvp/openrouter_engine.py`(실제 Production 코드 존재, `tests/test_openrouter_engine.py`로 회귀 검증됨 — 반영 확인됨, 4차 라운드. `BASELINE.md` §14 Kernel Public Contract 자체는 미반영 — Scoped 상태와 일치) | 본문 참조 | `docs/architecture/core/ADR-0026-openrouter-free-model-selection-architecture-boundary.md` | 2026-09-20 | High |
| ADR-0027 | OpenRouter Production Engine Migration Adoption(Scoped) | ADR | Kernel | Accepted(Scoped — Production Routing Integration/3번째 Engine 승인, §9 Operational Validation은 NOT YET DETERMINED) | DG-KERNEL-0041 | `docs/architecture/core/ADC-0044-openrouter-production-engine-migration-decision.md`, `docs/architecture/core/ADC-0043`(재인용) | `hqs/development/mvp/openrouter_engine.py`(동일 근거 — 반영 확인됨, 4차 라운드) | 본문 참조 | `docs/architecture/core/ADR-0027-openrouter-production-engine-migration-adoption.md` | 2026-09-20 | High |
...
| ADR-0001 | Development HQ Baseline에 Stage 기반 구조 반영(ADC-0003 판단 1) | ADR | Development HQ | Accepted(§2/§6은 ADR-0008이 Supersede — 문서 자체는 수정 안 함) | DG-DEVHQ-0003 | `docs/governance/adc/ADC-0003.md` 판단 1 | `hqs/development/STRUCTURE.md`(17행, "Stage 정의는 hqs/development/stages/를 참조(ADR-0001, ADR-0008)" 명시 — 반영 확인됨, 4차 라운드) | 본문 참조 | `docs/decisions/adr/ADR-0001-development-hq-stage-baseline-update.md` | 2026-09-20 | High |
| ADR-0006 | hqs/, core/execution/ 재배치 및 docs/ Taxonomy 정리 Migration Decision 확정 | ADR | Development HQ | Accepted(Decision만 확정, Migration 실행은 범위 밖) | DG-DEVHQ-0006 | `docs/decisions/adc/ADC-0005-structure-v1-migration-decisions.md` | `docs/architecture/baseline/STRUCTURE-V1.0-FROZEN.md`(255행, "ADR" 행에 ADR-0006/0007 명시 인용 — 반영 확인됨, 4차 라운드) | 본문 참조 | `docs/decisions/adr/ADR-0006-structure-v1-migration.md` | 2026-09-20 | High |
| ADR-0007 | Architecture Baseline 문서의 Structure v1.0 위치 확정 | ADR | Development HQ | Accepted(위치·Reference 정합성만 확정, 이동 미실행) | DG-DEVHQ-0006 | `docs/decisions/adc/ADC-0006-baseline-relocation-decision.md` | `docs/architecture/baseline/STRUCTURE-V1.0-FROZEN.md`(255행, 동일 인용 — 반영 확인됨, 4차 라운드) | 본문 참조 | `docs/decisions/adr/ADR-0007-baseline-relocation.md` | 2026-09-20 | High |
| ADR-0008 | Stage 폴더의 문서+실행 코드 공존 허용(Architecture Owner 직접 지시) | ADR | Development HQ | Accepted | DG-DEVHQ-0003 | 없음(직접 지시 — ADC 경유 없음) | `hqs/development/STRUCTURE.md`(17~19행, ADR-0001 §2/§6 Supersede 명시), `hqs/development/HANDOVER.md`(반영 확인됨, 4차 라운드) | 본문 참조 | `docs/decisions/adr/ADR-0008-stage-folder-code-and-docs.md` | 2026-09-20 | High |
| ADR-0009 | Stage Data Contract Baseline 반영 | ADR | Development HQ | Accepted | DG-DEVHQ-0009 | `docs/governance/adc/ADC-0007.md` | `hqs/development/BASELINE.md` §"Stage Data Contract (ADR-0009)"(40행, 반영 확인됨, 4차 라운드) | 본문 참조 | `docs/decisions/adr/ADR-0009-stage-data-contract-baseline.md` | 2026-09-20 | High |
