...
**다음 배치 권장**: Batch 3(DevHQ-ADR Medium + ExecLayer 전체 Medium,
§5 기준 약 8건). 착수 전 §9-5의 재확인 절차(판정 ADC/ADR의 §번호·
라벨 직접 인용 여부 grep 재확인)를 반드시 먼저 수행하고, 발견되는
문서는 기법 B 대신 기법 C로 전환할 것을 전제로 진행한다.
