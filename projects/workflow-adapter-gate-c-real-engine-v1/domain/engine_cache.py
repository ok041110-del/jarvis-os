"""Record-once-replay 캐시 — 실제 Engine 비결정성과 어댑터 정합성 검증을 분리하기 위한 장치. Reversibility 검증 자체가 아니다.

`hqs/development/mvp/engine.py::call_engine()`(ENGINE-CONNECT-0001)을 **read-only import**한다 — 이 파일도, `hqs/development/`·`hqs/investment/` 어느 것도 수정하지 않는다.
"""
