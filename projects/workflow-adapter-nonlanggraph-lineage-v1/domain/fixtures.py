...
- clean: 정합 데이터 -> 3라운드 수렴 -> BUY -> final_report -> COMPLETED - data_gap: sentiment 소스 충돌 -> 3라운드 수렴 -> HOLD -> escalate -> ESCALATED_DATA_GAP - node_error: analyst_fundamental 노드가 예외 raise (IN-2 catch-and-encode 검증), 나머지는 clean과 동일 -> COMPLETED (+ data_flags에 NODE_ERROR 기록)
"""
