"""Dashboard — Observe-only. vs_pipeline을 import하지 않는다(실행을 시작/재시도할 수단이 이 모듈에 없다).

RUNNING 상태는 Task Registry(runtime-boundary의 rtb_task 재사용)에서, 완료 결과는 Result Store(파일)에서 읽는다.
"""
