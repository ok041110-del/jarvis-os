"""Toyota Dividend Stock Analysis runner — Dev HQ timeout 재현성 검증 Dogfooding.
...
— Workflow Parser/Scheduler/Dispatcher를 만들지 않는다(Stock/ETF
runner.py와 동일한 성격).

Stock/ETF와 동일하게 각 호출의 입력 길이/출력 길이/소요 시간을
...
ISSUE_DIR = PROJECT_ROOT / "issues" / "0001-toyota-analysis"
...
_COMPANY_HEADER = "Company: Toyota Motor Corporation (Primary: 7203.T, ADR: TM)"
