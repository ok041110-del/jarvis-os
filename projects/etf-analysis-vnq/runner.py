"""VNQ ETF Analysis runner (다섯 번째 ETF 반복 실행, 최초의 REIT형 ETF).
...
Parser/Scheduler/Dispatcher를 만들지 않는다(QQQ/SCHD/AGG/GLD runner.py와
동일한 성격).

JPM/AGG/GLD와 동일하게 각 호출의 입력 길이/출력 길이/소요 시간을
...
ISSUE_DIR = PROJECT_ROOT / "issues" / "0001-vnq-analysis"
...
_FUND_HEADER = "Fund: Vanguard Real Estate ETF (Ticker: VNQ)"
