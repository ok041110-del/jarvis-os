"""Enterprise Products Partners(EPD) Dividend Stock Analysis runner —
신규 표준 실행 패턴 2번째 프로덕션 적용(PR #80에서 검증·채택: 병렬화 +
출력 최적화 + Checkpointing + 180초 Timeout 안전장치).
...
단계 완료 즉시 `issues/0001-epd-analysis/checkpoints/`에
...
ISSUE_DIR = PROJECT_ROOT / "issues" / "0001-epd-analysis"
...
_COMPANY_HEADER = "Company: Enterprise Products Partners L.P. (Ticker: EPD)"
