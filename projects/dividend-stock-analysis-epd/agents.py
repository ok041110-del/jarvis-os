"""Dividend Stock Analysis Capability 함수 — Enterprise Products
Partners L.P.(MLP). 기존 Dogfooding들과 동일한 project-local 구현이며
역할 지시문은 한 글자도 바뀌지 않았다(회사명/티커만
report_writer_final_report에서 교체).
...
def report_writer_final_report(
    ...
    instruction = (
        "Write a final research report for Enterprise Products Partners L.P. (NYSE: EPD) that integrates all sections "
