"""Candidate Selection의 5개 Case(0/1/2/3/>3)를 실제 Free Pool 메타데이터로 재현한다 — 실제 Stage Requirement는 항상 `>3_candidates`이므로 나머지 4개 case는 합성 Requirement(실측 메타데이터 분포 기반 임계값)로 만든다.
Chat Completions는 호출하지 않는다(Free Pool 조회 + Filter + Selection만, quota 미소모)."""
