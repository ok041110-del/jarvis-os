"""KO Dividend Stock Analysis runner — 2번째 Dividend Stock Dogfooding
...
— Workflow Parser/Scheduler/Dispatcher를 만들지 않는다(JNJ/Stock/ETF
runner.py와 동일한 성격).
...
ISSUE_DIR = PROJECT_ROOT / "issues" / "0001-ko-analysis"
...
_COMPANY_HEADER = "Company: The Coca-Cola Company (Ticker: KO)"
