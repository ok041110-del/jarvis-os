...
| [`integrations/llm-wiki-candidate-002-adoption-policy.md`](integrations/llm-wiki-candidate-002-adoption-policy.md) | LLM Wiki Candidate #2 Adoption Policy(MCP-first Hybrid) + 사용자 Live Smoke 체크리스트 |
