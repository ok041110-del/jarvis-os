...
| [`integrations/llm-wiki-candidate-002-adoption-readiness.md`](integrations/llm-wiki-candidate-002-adoption-readiness.md) | LLM Wiki Candidate #2 Production Adoption Readiness — Conditional Pass, BLOCKING 게이트 B1~B4 |
