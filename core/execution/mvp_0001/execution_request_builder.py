...
Implementation Specification(Development HQ 산출물)을 Execution Request로 변환한다. Transformation만 수행하고 Interpretation(해석· 요약·재구성)은 하지 않는다 — 입력을 한 글자도 바꾸지 않고 머리말만 붙인다. Contract 상세: docs/core/execution-layer/MVP-0001-plan.md
"""
