...
Development HQ가 생성하는 Implementation Specification부터 MVP-0001~0005 Builder를 통과시켜 Artifact Chain을 검증한다. 읽기(호출)만 하며 어떤 파일도 수정하지 않는다.
"""
...
sys.path.insert(0, str(REPO_ROOT / "hqs" / "development"))
